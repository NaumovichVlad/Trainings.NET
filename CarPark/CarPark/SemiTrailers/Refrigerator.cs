...
namespace CarPark.SemiTrailers
{
    ...
    {
        public Refrigerator(string type, int liftingCapacity, int availableVolume, int availableMass, string uploadedProductType, int occupiedVolume, int occupiedWeight)
