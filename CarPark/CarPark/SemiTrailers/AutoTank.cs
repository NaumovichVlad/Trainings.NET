...
{
    public class AutoTank : SemiTrailer
    {
        public AutoTank(string type, int liftingCapacity, int availableVolume, int availableMass, string uploadedProductType, int occupiedVolume, int occupiedWeight)
